    ...
    <figure className="policy-figure" aria-labelledby="policy-diagram-title">
      ...
      >
        ...
        <g className="diagram-node diagram-node-accent">
          ...
          <text className="diagram-small" x="280" y="111">scores each legal action</text>
        </g>

        <g className="diagram-node">
          <rect height="100" rx="2" width="206" x="260" y="174" />
          <text x="280" y="200">ACTION SCORER</text>
          <text className="diagram-small" x="280" y="225">mechanics · identities</text>
          <text className="diagram-small" x="280" y="246">both teams · 4 recent turns</text>
        </g>

        <g className="diagram-node diagram-node-accent">
          <rect height="92" rx="2" width="166" x="556" y="124" />
          <text x="576" y="151">COMBINE SCORES</text>
          <text className="diagram-small" x="576" y="176">Qwen score + 0.75 ×</text>
          <text className="diagram-small" x="576" y="195">action-scorer score</text>
        </g>

        <g className="diagram-node">
          <rect height="76" rx="2" width="136" x="38" y="274" />
          <text x="58" y="300">SHOWDOWN</text>
          <text className="diagram-small" x="58" y="325">removes illegal choices</text>
        </g>

        <g className="diagram-node diagram-node-dark">
          <rect height="76" rx="2" width="166" x="556" y="269" />
          <text x="576" y="296">FINAL ACTION</text>
          <text className="diagram-small" x="576" y="321">highest legal score</text>
        </g>
      </svg>
      <figcaption>
        Qwen and the smaller action-scoring network rank the same legal choices. Their scores are combined, and
        the bot plays whichever legal action finishes highest.
      </figcaption>
    </figure>
  )
}
